...
- POI 데이터가 3개 이상이면 서로 다른 실제 상권 중심을 최대한 추천 1·2·3으로 구성
...
The GitHub bootstrap is idempotent for an existing `v1.3.0` tag. A pre-existing remote release tag is kept instead of causing deployment to fail after a successful Pages deployment.
