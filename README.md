...
The GitHub bootstrap is idempotent for an existing `v1.4.0` tag. A pre-existing remote release tag is kept instead of causing deployment to fail after a successful Pages deployment.
