...
어?중간 is a static GitHub Pages application. Any configuration required by browser JavaScript is observable by visitors. Security therefore relies on **least-privilege browser keys and server-side authorization**, not on hiding frontend strings.
