...
export function loadKakaoMaps() {
  ...
  loaderPromise = new Promise((resolve, reject) => {
    ...
    script.onerror = () => {
      window.clearTimeout(timer);
      reject(new Error('Kakao Maps SDK failed to load. Check Kakao Map API activation, JavaScript key type, and JavaScript SDK domain registration for https://ko9ma7.github.io.'));
    };
