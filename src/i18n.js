...
const messages = {
  ...
  en: {
    ...
    'results.placeCluster': '{count} food & drink places', 'results.recommendationIntro': 'The mathematical midpoint can land on a mountain or roadside. MeetHalfway instead compares nearby commercial clusters with distance balance and suggests three practical areas.', 'results.selectArea': 'View this area', 'results.selectedArea': 'Selected meeting area', 'results.selectedHint': 'The map is zoomed into this area. Filter nearby places by category below.', 'results.placesHeading': 'Places to eat and drink here', 'results.all': 'All', 'results.categoryRestaurant': 'Restaurants', 'results.categoryCafe': 'Cafes', 'results.categoryQuick': 'Quick bites', 'results.categoryBar': 'Bars', 'results.noPlacesInCategory': 'No places in this category.', 'results.placeCount': 'Food & drink', 'results.cafeCount': 'Cafes', 'results.restaurantCountShort': 'Restaurants', 'results.centerDistanceLabel': 'From mathematical midpoint', 'results.maxTravelLabel': 'Farthest attendee', 'results.openPlace': 'Open place', 'results.recommendationCount': 'Suggested areas',
  ...
  ja: {
    ...
    'results.placeCluster': '飲食スポット {count}件', 'results.recommendationIntro': '数学的な中間点が山や郊外になる場合でも、そこを集合場所にはしません。周辺の商業密度と距離バランスを比較し、実用的な3エリアを提案します。', 'results.selectArea': 'このエリアを見る', 'results.selectedArea': '選択した集合エリア', 'results.selectedHint': '地図をこのエリアに拡大しました。下でカテゴリ別に店を選べます。', 'results.placesHeading': 'このエリアの飲食スポット', 'results.all': 'すべて', 'results.categoryRestaurant': '飲食店', 'results.categoryCafe': 'カフェ', 'results.categoryQuick': '軽食', 'results.categoryBar': 'バー', 'results.noPlacesInCategory': 'このカテゴリの場所はありません。', 'results.placeCount': '飲食スポット', 'results.cafeCount': 'カフェ', 'results.restaurantCountShort': '飲食店', 'results.centerDistanceLabel': '数学的中間点から', 'results.maxTravelLabel': '最も遠い参加者まで', 'results.openPlace': '場所を見る', 'results.recommendationCount': 'おすすめエリア',
  ...
  zh: {
    ...
    'results.placeCluster': '餐饮地点 {count} 个', 'results.recommendationIntro': '数学中间点可能落在山里或偏僻道路上。MeetHalfway 会结合附近商业密度和距离平衡，推荐三个更适合实际见面的区域。', 'results.selectArea': '查看此区域', 'results.selectedArea': '已选见面区域', 'results.selectedHint': '地图已放大到此区域，可在下方按类别筛选餐饮地点。', 'results.placesHeading': '此区域的餐饮地点', 'results.all': '全部', 'results.categoryRestaurant': '餐厅', 'results.categoryCafe': '咖啡馆', 'results.categoryQuick': '快餐', 'results.categoryBar': '酒吧', 'results.noPlacesInCategory': '此类别暂无地点。', 'results.placeCount': '餐饮地点', 'results.cafeCount': '咖啡馆', 'results.restaurantCountShort': '餐厅', 'results.centerDistanceLabel': '距数学中间点', 'results.maxTravelLabel': '最远参与者距离', 'results.openPlace': '查看地点', 'results.recommendationCount': '推荐区域',
