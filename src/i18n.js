...
const messages = {
  ...
  zh: {
    ...
    'results.placeCluster': '餐饮地点 {count} 个', 'results.recommendationIntro': '数学中间点可能落在山里或偏僻道路上。어?중간 会结合附近商业密度和距离平衡，推荐三个更适合实际见面的区域。', 'results.selectArea': '查看此区域', 'results.selectedArea': '已选见面区域', 'results.selectedHint': '地图已放大到此区域，可在下方按类别筛选餐饮地点。', 'results.placesHeading': '此区域的餐饮地点', 'results.all': '全部', 'results.categoryRestaurant': '餐厅', 'results.categoryCafe': '咖啡馆', 'results.categoryQuick': '快餐', 'results.categoryBar': '酒吧', 'results.noPlacesInCategory': '此类别暂无地点。', 'results.placeCount': '餐饮地点', 'results.cafeCount': '咖啡馆', 'results.restaurantCountShort': '餐厅', 'results.centerDistanceLabel': '距数学中间点', 'results.maxTravelLabel': '最远参与者距离', 'results.openPlace': '查看地点', 'results.recommendationCount': '推荐区域',
