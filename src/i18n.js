...
const messages = {
  ko: {
    ...
    'about.eyebrow': 'ABOUT MEETHALFWAY',
    'about.title': '모두에게 설명하기 쉬운, 공유형 중간지점 찾기',
    'about.intro': 'MeetHalfway는 모임장이 링크 하나를 만들고 참석자들이 각자의 출발점을 입력하면, 마감 시점에 공정한 중간지점과 식당 밀집 후보를 계산하는 정적 웹서비스입니다.',
    ...
    'meeting.closedSummary': '아래에서 중간지점과 식당 후보를 확인하세요.',
    ...
    'results.description': '지도 공급자의 식당 데이터를 이용합니다. 실제 영업 여부와 다를 수 있습니다.',
    'results.loading': '주변 식당과 추천 지역을 계산하는 중…',
  ...
  en: {
    brand: 'MeetHalfway', 'brand.en': 'MeetHalfway',
    ...
    'home.description': 'Create a meeting link and let everyone enter where they start. At the deadline, MeetHalfway compares distance balance and restaurant density to suggest meeting areas.',
    ...
    'about.eyebrow': 'ABOUT MEETHALFWAY', 'about.title': 'A shareable midpoint finder that is easy to explain to everyone', 'about.intro': 'MeetHalfway is a static web service where a host creates one link, attendees add their starting points, and the service computes a fair midpoint plus restaurant-dense candidate areas when entries close.',
    ...
    'map.loading': 'Preparing map…', 'map.failed': 'Could not load the map.', 'map.network': 'Check your network connection and map API configuration.', 'map.center': 'Balanced midpoint', 'map.centerShort': 'Midpoint', 'map.recommendation': 'Suggested area {n}', 'map.restaurantCount': '{count} restaurants in this cluster',
  ...
  ja: {
    brand: '中間で会おう', 'brand.en': 'MeetHalfway',
    ...
    'map.loading': '地図を準備中…', 'map.failed': '地図を読み込めませんでした。', 'map.network': 'ネットワーク接続と地図API設定を確認してください。', 'map.center': 'バランス中間地点', 'map.centerShort': '中間地点', 'map.recommendation': 'おすすめエリア {n}', 'map.restaurantCount': 'この区画に飲食店 {count} 件',
    'count.closed': '受付終了', 'count.days': '残り {days}日 {hours}時間', 'count.hours': '残り {hours}時間 {minutes}分', 'count.minutes': '残り {minutes}分'
  },
  zh: {
    brand: '中途会面', 'brand.en': 'MeetHalfway',
    ...
    'map.loading': '正在准备地图…', 'map.failed': '无法加载地图。', 'map.network': '请检查网络连接和地图API设置。', 'map.center': '平衡中间点', 'map.centerShort': '中间点', 'map.recommendation': '推荐区域 {n}', 'map.restaurantCount': '该区域餐厅 {count} 家',
