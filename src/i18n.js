...
const messages = {
  ko: {
    ...
    'results.spatialTitle': '중간점 중심 3D 추천 포인트',
    'results.spatialHint': '실제 중간점과 추천 상권의 상대 위치를 입체적으로 보여줍니다. 포인트를 눌러 선택하거나 다시 눌러 해제하세요.',
    'results.spatialCandidate': '추천 상권',
    'results.spatialToggle': '포인트 선택 ↔ 다시 누르면 해제',
    'results.midpointCore': '수학적 중간점',
    'results.spatialPick': '추천',
    'admin.title': '생성자 관리키',
  ...
  en: {
    ...
    'results.spatialTitle': '3D checkpoints around the midpoint', 'results.spatialHint': 'See the real relative positions of the midpoint and recommended commercial areas. Select a point or tap it again to clear.', 'results.spatialCandidate': 'Recommended area', 'results.spatialToggle': 'Select a point ↔ tap again to clear', 'results.midpointCore': 'Mathematical midpoint', 'results.spatialPick': 'Pick',
  ...
  ja: {
    ...
    'results.spatialTitle': '中間点中心の3Dおすすめポイント', 'results.spatialHint': '中間点とおすすめ商業エリアの実際の相対位置を立体表示します。ポイントを押して選択し、もう一度押すと解除できます。', 'results.spatialCandidate': 'おすすめエリア', 'results.spatialToggle': 'ポイント選択 ↔ 再タップで解除', 'results.midpointCore': '数学的中間点', 'results.spatialPick': 'おすすめ',
  ...
  zh: {
    ...
    'results.spatialTitle': '以中间点为中心的 3D 推荐点', 'results.spatialHint': '立体显示数学中间点与推荐商业区域的实际相对位置。点击可选择，再次点击可取消。', 'results.spatialCandidate': '推荐区域', 'results.spatialToggle': '点击选择 ↔ 再次点击取消', 'results.midpointCore': '数学中间点', 'results.spatialPick': '推荐',
