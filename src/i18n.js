...
const messages = {
  ...
  ja: {
    ...
    'map.loading': '地図を準備中…', 'map.failed': '地図を読み込めませんでした。', 'map.network': 'ネットワーク接続と地図API設定を確認してください。', 'map.center': 'バランス中間地点', 'map.centerShort': '中間地点', 'map.recommendation': 'おすすめエリア {n}', 'map.restaurantCount': 'この区画に飲食店 {count} 件', 'map.copyAddress': '住所をコピー', 'map.sharePlace': '共有', 'map.openPlace': '詳細', 'map.copied': 'コピー済み', 'map.provider': 'データ', 'map.demoData': 'デモデータ',
  ...
  zh: {
    ...
    'map.loading': '正在准备地图…', 'map.failed': '无法加载地图。', 'map.network': '请检查网络连接和地图API设置。', 'map.center': '平衡中间点', 'map.centerShort': '中间点', 'map.recommendation': '推荐区域 {n}', 'map.restaurantCount': '该区域餐厅 {count} 家', 'map.copyAddress': '复制地址', 'map.sharePlace': '分享', 'map.openPlace': '详情', 'map.copied': '已复制', 'map.provider': '数据', 'map.demoData': '示例数据',
